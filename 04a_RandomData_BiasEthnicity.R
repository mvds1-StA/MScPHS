### SECTION 04a_RandomData_BiasEthnicity
### This section biases the randomly created simulated data based on the variable ethnicity.
...
white_bias_random <- 0.55
black_bias_random <- 0.075
indian_bias_random <- 0.075
pakistani_bias_random <- 0.075
chinese_bias_random <- 0.075
other_bias_random <- 0.075
notKown_bias_random <- 0.075
...
save (
  ...
  file=sprintf( "files_created/04a_BiasedRandomDataEthnicity.Rdat",
                number_patients )
)
